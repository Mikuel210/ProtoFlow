...
public static class ConsoleUtilities {
	...
	public static void Communication(string message) => WriteTitledMessage("Comms", message, ConsoleColor.Magenta);
	public static void Debug(string message) {
		if (DEBUG)
			WriteTitledMessage("Debug", message, ConsoleColor.DarkMagenta);
	}
